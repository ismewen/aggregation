...
from {{cookiecutter.project_slug}}.core.unnittest.testcase import AggregationTestCase
from {{cookiecutter.project_slug}}.api.modules.tests.tests.factorys import ParentFactory, ChildFactory
from {{cookiecutter.project_slug}}.api.modules.tests.views import ParentAPIView, ChildAPIView
from {{cookiecutter.project_slug}}.api.modules.tests.schemas import ParentModelSchema, SonModelSchema


class ParentTestCaseAuthorizedTestCase(AggregationTestCase):
...
class SonTestCase(AggregationTestCase):
